...
<head>
	...
	.users { display:block; }
	.board { float: left; }
	.caller__ctrl { display:none; }
	.caller__name { margin:0px; }
	.caller__frames_acts_btn_record { display:none; }
	</style>
</head>
<body>
        ...
        <main class="app" id="app">
            <div class="page">
                ...
                <form class="join j-join">
                    ...
                    <div class="join__body" style="background-color:blue;">
                        <!--
                        <div class="join__row">
    ...
    <!-- QB -->
    <script src="https://www.drallcaps.com/video-app/quickbox/quickblox.min.js"></script>
